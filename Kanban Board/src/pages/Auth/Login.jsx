                    ...
                    <div className="flex items-center justify-center w-full lg:p-12">
                        <div className="flex items-center xl:p-10">
                            <form onSubmit={handleSignIn} className="flex flex-col w-full h-full pb-6 text-center bg-white rounded-3xl">
                                ...
                                <p className="text-sm leading-relaxed text-gray-900">Not registered yet? <Link to="/signup" className="font-semibold text-purple-700 hover:underline">Sign Up</Link></p>
                            </form>
                        </div>
                    </div>
                </div>
